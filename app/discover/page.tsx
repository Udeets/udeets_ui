...
type FilterCard = {
  ...
  iconBg: string;
  href: string; // where the card should navigate
};
...
export default function DiscoverPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* TOP STRIP */}
      <header className="bg-gradient-to-br from-teal-600 to-cyan-700">
      ...
      {/* HERO */}
      <section className="relative overflow-hidden bg-gradient-to-br from-teal-600 to-cyan-700">
        ...
        <div className="relative max-w-4xl mx-auto px-6 lg:px-8 text-center py-20 sm:py-24">
          ...
          <div className="max-w-2xl mx-auto">
            <div className="relative">
              ...
              />
              <button className="absolute right-3 top-1/2 -translate-y-1/2 bg-gradient-to-br from-teal-600 to-cyan-700 text-white px-7 py-3.5 rounded-xl font-extrabold shadow-xl hover:scale-105 transition-transform duration-300">
                Search
              </button>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          {/* padding to keep arrows extreme + never overlap cards */}
          <div className="relative pl-20 pr-20">
            ...
            <button
              ...
              className={`hidden lg:flex absolute left-0 top-1/2 -translate-y-1/2 bg-white w-14 h-14 rounded-full shadow-xl items-center justify-center hover:scale-110 transition-all duration-300 border-2 border-gray-200 hover:border-teal-600 z-10 ${
            ...
            <button
              ...
              onClick={() => scrollToIndex(pageIndex + 1)}
              className={`hidden lg:flex absolute right-0 top-1/2 -translate-y-1/2 bg-white w-14 h-14 rounded-full shadow-xl items-center justify-center hover:scale-110 transition-all duration-300 border-2 border-gray-200 hover:border-teal-600 z-10 ${
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="bg-gradient-to-br from-teal-600 to-cyan-700 rounded-3xl p-12 sm:p-16 lg:p-20 text-center relative overflow-hidden">
            <div className="absolute inset-0 opacity-10 pointer-events-none">
              <div className="absolute -top-24 -left-24 w-[320px] h-[320px] bg-white rounded-full blur-3xl" />
              <div className="absolute -bottom-32 -right-32 w-[420px] h-[420px] bg-white rounded-full blur-3xl" />
            </div>
            ...
            <div className="relative">
              ...
              <p className="text-white/90 text-lg sm:text-xl mb-10 max-w-2xl mx-auto">
                Create a space for your community, business, or organization and connect with people who share your interests.
              </p>

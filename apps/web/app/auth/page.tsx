      ...
      <main className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-10">
        <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8 w-full max-w-md">
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-br from-teal-500 via-cyan-500 to-blue-500 text-white py-3 px-4 rounded-xl font-semibold hover:opacity-95 transition shadow-lg"
            >

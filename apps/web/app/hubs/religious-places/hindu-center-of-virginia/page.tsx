    ...
    <main className="font-sans antialiased bg-gray-50 text-gray-800">
      ...
      <section className="relative w-full h-[500px] md:h-[600px] overflow-hidden bg-gray-900">
        ...
        <div className="absolute inset-0">
          <Image
            src="/hub-images/hcv-dp.jpg"
            alt="Hindu Center of Virginia"
            fill
        ...
        <div className="relative z-10 h-full flex flex-col justify-center items-center text-center px-4">
          ...
          <Link
            href="/auth"
            className={`${GRADIENT} hover:opacity-95 text-white px-8 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 active:scale-95 inline-flex items-center gap-2`}
          >
      ...
      <section className="max-w-6xl mx-auto px-4 py-8 md:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            {/* About */}
            <Card title="About the Center" icon="ℹ️" titleClass="text-gray-900">
            ...
            <Card
              ...
              icon="📆"
              rightLink={
                <Link href="#" className="text-sm text-gray-700 hover:underline font-medium">
                  View All
                </Link>
              }
          ...
          <div className="flex flex-col gap-6">
            ...
            <Card title="Visit & Contact" icon="📍" titleClass="text-gray-900">
              <div className="space-y-5">
                ...
                <InfoRow icon="✉️" label="Email" lines={["info@hinducenterofvirginia.org"]} />
              </div>

              {/* Mini map */}
              <div className="h-32 bg-gray-100 relative mt-6 rounded-lg overflow-hidden">
                <Image
                  src="/hub-images/hcv1.jpg"
                  alt="HCV area snapshot"
                  fill
            ...
            <section className="rounded-xl shadow-md border border-gray-200 overflow-hidden relative bg-white">
              ...
              <div className="p-6 relative z-10">
                <h2 className="text-xl font-bold text-gray-900 mb-3">Support the Temple</h2>
                <p className="text-gray-600 mb-6 text-sm leading-relaxed">
                  Devotees can contribute to support temple operations, community programs, and cultural events.
                </p>

                <Link
                  href="/auth"
                  className={`${GRADIENT} block w-full text-center text-white py-3 px-4 rounded-xl font-bold shadow-lg hover:opacity-95 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-0.5 active:scale-95`}
                >
                  Donate Now
                </Link>
      ...
      <section className="bg-white border-t border-gray-200 py-12 mt-8">
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            <GalleryCard title="Temple Exterior" src="/hub-images/hcv-dp.jpg" />
            <GalleryCard title="Campus Grounds" src="/hub-images/hcv1.jpg" />
            <GalleryCard title="Community Moment" src="/hub-images/hcv2.jpg" />
          </div>
...
function EventCard({
  ...
  return (
    <div className="group cursor-pointer border border-gray-100 rounded-lg p-4 hover:bg-gray-50 transition-colors hover:border-cyan-200">
      ...
      <h3 className="font-bold text-gray-800 mb-1 group-hover:text-gray-900 transition-colors">{title}</h3>
...
function GalleryCard({ src, title }: { src: string; title: string }) {
  return (
    <div className="min-w-[280px] md:min-w-[320px] h-56 rounded-lg overflow-hidden relative shadow-sm snap-center group bg-gray-100">

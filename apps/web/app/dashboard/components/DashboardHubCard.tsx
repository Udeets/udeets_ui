...
export function DashboardHubCard({
  ...
  // If accepted, clicking should trigger the celebration instead of navigating
  if (isAccepted && onAcceptedClick) {
    return (
      <button
        type="button"
        onClick={() => onAcceptedClick(hub)}
      ...
      >
        ...
        >
          ...
          {/* Accepted badge */}
          <div className="absolute inset-x-0 bottom-0 bg-emerald-500/90 py-0.5 text-center text-[9px] font-semibold text-white">
            Accepted
          </div>

          {/* Green dot — indicates acceptance needs attention */}
          <div className="absolute bottom-0 right-0 z-10">
            ...
            <div className="relative mb-[3px] mr-[3px] h-2.5 w-2.5 rounded-full bg-emerald-500 ring-2 ring-white" />
          </div>
        </div>

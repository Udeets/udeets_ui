  ...
  return (
    <MockAppShell activeNav="alerts">
      <section className="mb-4">
        <h1 className="text-3xl font-semibold tracking-tight text-[#111111]">Alerts</h1>
        ...
        {ALERTS.length ? (
          ALERTS.map((alert) => (
            <article key={alert.id} className={cardClass("p-5 sm:p-6")}>
              ...
              <h2 className="mt-3 text-xl font-semibold text-[#111111]">{alert.title}</h2>
          ...
          <article className={cardClass("p-5 text-center sm:p-6")}>
            <h2 className="text-xl font-semibold text-[#111111]">No alerts yet</h2>
